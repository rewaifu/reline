...
def hsv_halftone(
    ...
    img[..., 2] = screentone(img[..., 2], dot_size[0], angle[0], dot_type[0], scale, ssaa_filter, disable_auto_dot)
...
def gray_halftone(
    ...
    return screentone(img, dot_size[0], angle[0], dot_type[0], scale, ssaa_filter, disable_auto_dot)
